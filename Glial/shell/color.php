...
class color
{
	...
	public function print_all()
	{
		...
		for ( $i = 0; $i < $count; $i++ )
		{
			echo $this->get_colored_string("Test Foreground colors", $fgs[$i]) . "\t";
			if ( isset($bgs[$i]) )
			{
				echo $this->get_colored_string("Test Background colors", null, $bgs[$i]);
			}
			echo "\n";
		}
		echo "\n";
		...
		foreach ( $fgs as $fg )
		{
			foreach ( $bgs as $bg )
			{
				echo $this->get_colored_string("Test Colors", $fg, $bg) . "\t";
			}
			echo "\n";
		}
	}
