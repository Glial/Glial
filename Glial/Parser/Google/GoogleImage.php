...
namespace \Gliale\Parser\Google;
...
class GoogleImage
{
    ...
    public function get_image()
    {
        ...
        $tab = Grabber::getTagContent($content, '<table width="100%" class="images_table" style="table-layout:fixed"', true);

        $grid = Grabber::getTagContents($tab, '<td', true);
