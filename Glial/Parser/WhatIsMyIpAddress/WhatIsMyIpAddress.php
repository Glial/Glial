...
class WhatIsMyIpAddress
{
    ...
    public static function getInfoFromIp($adresse_ip)
    {
        ...
        $tab = Grabber::getTagContents($data_brut, '<table', true);
        ...
        $tab1 = Grabber::getTagContents($tab[0], '<td', true);
        $tab2 = Grabber::getTagContents($tab[1], '<td', true);

        $tab3 = Grabber::getTagContents($tab[0], '<th', true);
        $tab4 = Grabber::getTagContents($tab[1], '<th', true);
        ...
        $ip['services'] = $tab1[4];
        $ip['type'] = Grabber::getTagContent($tab1[5], '<a', true);
        $ip['assignment'] = Grabber::getTagContent($tab1[6], '<a', true);
