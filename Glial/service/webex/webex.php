...
class webex {
    ...
    static function test_microsite($url) {
        $timeout = 10;
...
// Fermeture de la session cURL 
    ...
    static function xml_post($post_xml, $url, $port) {
    ...
    static function clean_xml($answer) {
    ...
    static function get_user_detail($sitename, $login, $password, $webex_id) {
...
<webExId>' . $webex_id . '</webExId>
    ...
    static function get_microsite_users($sitename, $login, $password, $start_from, $nb_users) {
        $xml = '<?xml version="1.0" encoding="UTF-8"?>
<serv:message xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:serv="http://www.webex.com/schemas/2002/06/service">
<header>
<securityContext>
...
<orderAD>ASC</orderAD>
    ...
    static function test_answer($xml) {
        if ($xml) {
    ...
    static function generate_url($site_name) {
        return "https://" . $site_name . ".webex.com/WBXService/XMLService";
    }
    static function clean_site_name($site_name) {
